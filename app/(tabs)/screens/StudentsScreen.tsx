...
export default function StudentsScreen() {
  ...
  const students = [
    { id: "1", name: "Ahmad", rollNo: "BSCS-001", semester: "7th", gpa: 3.7, attendance: 90 },
    { id: "2", name: "Saba", rollNo: "BSCS-002", semester: "7th", gpa: 3.9, attendance: 96 },
    { id: "3", name: "ali", rollNo: "BSCS-003", semester: "7th", gpa: 3.4, attendance: 85 },
    { id: "4", name: "fiza", rollNo: "BSCS-004", semester: "7th", gpa: 3.85, attendance: 92 },
  ];
